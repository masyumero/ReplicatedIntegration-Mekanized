...
abstract class MekanizedRecipeMapperGroup : RecipeMapperGroup() {
    protected fun ItemStackIngredient.toInputNode(): InputNodes =
        ingredientToInputNode(
            ingredient = this as InputIngredient<ItemStack>,
            nodeOf = BuiltinNodeResolver::itemNode,
        )

    protected fun FluidStackIngredient.toInputNode(): InputNodes =
        ingredientToInputNode(
    ...
    protected fun ChemicalStackIngredient<*, *>.toInputNode(scale: Long = 1L): InputNodes =
        ingredientToInputNode(
    ...
    protected fun <T> ingredientToInputNode(
    ...
    protected fun <T> List<T>.singleNodeAmountOrNull(mapper: (T) -> NodeAmount?): NodeAmount? =
